...
opts = Trollop::options do
  ...
  opt :category_id, "Category ID to process", :type => :integer
...
num_to_scrap.times do |i|
  page = start_index + i
  begin
    response = RestClient.get "https://offerupnow.com/?cid=#{cid}&radius=50&page=#{page}", headers
